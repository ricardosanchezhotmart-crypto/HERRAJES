...
export const SEED_RAW: RawProduct[] = [
  ...
  /* ================= RIELES / CORREDERAS ================= */
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Spar Mediano Extensión Total 30 Kg",
    description: "Riel telescópico de extensión total con capacidad de 30 Kg, para cajones de peso medio.",
    specs: [{ key: "Capacidad de peso", value: "30 Kg" }, { key: "Extensión", value: "Total" }, { key: "Tipo", value: "Balinera" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-MED30-30", description: "Riel Spar Mediano Ext. Total 30Kg — 30 cm", attributes: { medida: "30 cm" }, price: 6865.91 },
      { sku: "RIEL-MED30-35", description: "Riel Spar Mediano Ext. Total 30Kg — 35 cm", attributes: { medida: "35 cm" }, price: 8026.32 },
      { sku: "RIEL-MED30-40", description: "Riel Spar Mediano Ext. Total 30Kg — 40 cm", attributes: { medida: "40 cm" }, price: 9003.69 },
      { sku: "RIEL-MED30-45", description: "Riel Spar Mediano Ext. Total 30Kg — 45 cm", attributes: { medida: "45 cm" }, price: 9689.68 },
      { sku: "RIEL-MED30-50", description: "Riel Spar Mediano Ext. Total 30Kg — 50 cm", attributes: { medida: "50 cm" }, price: 10718.69 },
      { sku: "RIEL-MED30-55", description: "Riel Spar Mediano Ext. Total 30Kg — 55 cm", attributes: { medida: "55 cm" }, price: 19638.13 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Spar Liviano Extensión Total 20 Kg",
    description: "Riel telescópico de extensión total con capacidad de 20 Kg, para cajones livianos.",
    specs: [{ key: "Capacidad de peso", value: "20 Kg" }, { key: "Extensión", value: "Total" }, { key: "Tipo", value: "Balinera" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-LIV20-30", description: "Riel Spar Liviano Ext. Total 20Kg — 30 cm", attributes: { medida: "30 cm" }, price: 5230.72 },
      { sku: "RIEL-LIV20-35", description: "Riel Spar Liviano Ext. Total 20Kg — 35 cm", attributes: { medida: "35 cm" }, price: 6319.25 },
      { sku: "RIEL-LIV20-40", description: "Riel Spar Liviano Ext. Total 20Kg — 40 cm", attributes: { medida: "40 cm" }, price: 9982.58 },
      { sku: "RIEL-LIV20-45", description: "Riel Spar Liviano Ext. Total 20Kg — 45 cm", attributes: { medida: "45 cm" }, price: 11794.92 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Repón Extensión Total Push To Open Zincado",
    description: "Riel de extensión total con sistema Push To Open (apertura al empujar), acabado zincado.",
    specs: [{ key: "Extensión", value: "Total" }, { key: "Sistema", value: "Push To Open" }, { key: "Acabado", value: "Zincado" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-PUSH-30", description: "Riel Repón Ext. Total Push To Open Zincado — 30 cm", attributes: { medida: "30 cm" }, price: 52263.79 },
      { sku: "RIEL-PUSH-35", description: "Riel Repón Ext. Total Push To Open Zincado — 35 cm", attributes: { medida: "35 cm" }, price: 57529.59 },
      { sku: "RIEL-PUSH-40", description: "Riel Repón Ext. Total Push To Open Zincado — 40 cm", attributes: { medida: "40 cm" }, price: 62742.27 },
      { sku: "RIEL-PUSH-45", description: "Riel Repón Ext. Total Push To Open Zincado — 45 cm", attributes: { medida: "45 cm" }, price: 57196.68 },
      { sku: "RIEL-PUSH-50", description: "Riel Repón Ext. Total Push To Open Zincado — 50 cm", attributes: { medida: "50 cm" }, price: 70225.3 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Tipo Pesado Extensión Total (Repón)",
    description: "Riel de extensión total tipo pesado, para cajones y bandejas de alta exigencia.",
    specs: [{ key: "Extensión", value: "Total" }, { key: "Tipo", value: "Pesado" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-PES-25", description: "Riel Tipo Pesado Ext. Total — 25 cm", attributes: { medida: "25 cm" }, price: 24313.83 },
      { sku: "RIEL-PES-30", description: "Riel Tipo Pesado Ext. Total — 30 cm", attributes: { medida: "30 cm" }, price: 25372.62 },
      { sku: "RIEL-PES-35", description: "Riel Tipo Pesado Ext. Total — 35 cm", attributes: { medida: "35 cm" }, price: 23539.19 },
      { sku: "RIEL-PES-40", description: "Riel Tipo Pesado Ext. Total — 40 cm", attributes: { medida: "40 cm" }, price: 24267.3 },
      { sku: "RIEL-PES-45", description: "Riel Tipo Pesado Ext. Total — 45 cm", attributes: { medida: "45 cm" }, price: 26135.67 },
      { sku: "RIEL-PES-50", description: "Riel Tipo Pesado Ext. Total — 50 cm", attributes: { medida: "50 cm" }, price: 27808.07 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Repón Extensión Total Cierre Lento",
    description: "Riel de extensión total con cierre lento amortiguado (slow motion) para un cierre suave y silencioso.",
    specs: [{ key: "Extensión", value: "Total" }, { key: "Sistema", value: "Cierre lento (slow motion)" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-RCL-35", description: "Riel Repón Ext. Total Cierre Lento — 35 cm", attributes: { medida: "35 cm" }, price: 47955.62 },
      { sku: "RIEL-RCL-40", description: "Riel Repón Ext. Total Cierre Lento — 40 cm", attributes: { medida: "40 cm" }, price: 50842.89 },
      { sku: "RIEL-RCL-45", description: "Riel Repón Ext. Total Cierre Lento — 45 cm", attributes: { medida: "45 cm" }, price: 54746.88 },
      { sku: "RIEL-RCL-50", description: "Riel Repón Ext. Total Cierre Lento — 50 cm", attributes: { medida: "50 cm" }, price: 56659.77 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Riel Spar Cierre Lento 30 Kg",
    description: "Riel telescópico con cierre lento amortiguado y capacidad de 30 Kg.",
    specs: [{ key: "Capacidad de peso", value: "30 Kg" }, { key: "Sistema", value: "Cierre lento" }],
    catalogPage: 185,
    variants: [
      { sku: "RIEL-SCL-35", description: "Riel Spar Cierre Lento 30Kg — 35 cm", attributes: { medida: "35 cm" }, price: 21407.17 },
      { sku: "RIEL-SCL-40", description: "Riel Spar Cierre Lento 30Kg — 40 cm", attributes: { medida: "40 cm" }, price: 23068.05 },
      { sku: "RIEL-SCL-50", description: "Riel Spar Cierre Lento 30Kg — 50 cm", attributes: { medida: "50 cm" }, price: 23844.01 },
    ],
  },
  {
    brandSlug: "spar",
    category: "Rieles",
    name: "Corredera Spar Tipo Europeo",
    description: "Corredera lateral tipo europeo (montaje bajo cajón), fácil instalación.",
    specs: [{ key: "Tipo", value: "Europeo / bajo cajón" }],
    catalogPage: 185,
    variants: [
      { sku: "CORR-EU-35B", description: "Corredera Spar Tipo Europeo 35 cm Blanca", attributes: { medida: "35 cm", color: "Blanca" }, price: 6385.4 },
      { sku: "CORR-EU-40B", description: "Corredera Spar Tipo Europeo 40 cm Blanca", attributes: { medida: "40 cm", color: "Blanca" }, price: 7309.06 },
      { sku: "CORR-EU-55C", description: "Corredera Spar Tipo Europeo 55 cm Café", attributes: { medida: "55 cm", color: "Café" }, price: 4971.44 },
    ],
  },
];
